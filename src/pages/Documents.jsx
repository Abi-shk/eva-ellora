    ...
    <div className="font-sans">
      ...
      <section className="text-center py-1">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 px-4 py-10">
          <button className="bg-customPurple h-[250px] w-full sm:w-[300px] md:w-[400px] text-white p-4 rounded-3xl shadow-md hover:bg-purple-900 flex flex-col justify-center items-center overflow-hidden">
          ...
          <button className="bg-customPurple h-[250px] w-full sm:w-[300px] md:w-[400px] text-white p-2 rounded-3xl shadow-md hover:bg-purple-900 flex flex-col justify-center items-center ">
